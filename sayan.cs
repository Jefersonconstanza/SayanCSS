...
.formulario {
  background: linear-gradient(to bottom, white, #fdd835);
  padding: 2rem;
  border-radius: 12px;
...
.modo-vegeta .barra-navegacion {
  background-color: #2e5aac;
  border-bottom: 4px solid #f27d0c;
}
